...
drives PR creation and merge. Activity stubs keep the test independent of
Docker, GitHub, the Anthropic API, and real stage subgraphs.
"""
...
async def _wait_until_gate_pending(handle) -> dict:
    ...
    raise AssertionError("workflow did not reach the durable HITL gate")
